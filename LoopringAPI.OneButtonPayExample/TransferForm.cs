namespace LoopringAPI.OneButtonPayExample
{
    public partial class TransferForm : Form
    {
        ...
        private void cbEnvironment_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            //                  The url of the exchange you will be interacting with
            client = new Client(cbEnvironment.SelectedItem.ToString().Split(" | ")[1]);
        ...
        private void btnMakePayment_Click(object sender, EventArgs e)
        {
            ...
            var result = client.Transfer(tbPayeeAddress.Text, cbPaymentToken.SelectedItem.ToString(), nudPaymentAmmount.Value, cbPaymentFeeToken.SelectedItem.ToString(), tbMemo.Text).Result;
